...
import { IRepository, ISearchebleRepository } from "../../../domain/repository/repository.interface";
...
export abstract class InMemorySearchableRepository<
  ...
  EntityId extends ValueObject,
  Filter = string
> extends InMemoryRepository<E, EntityId> implements ISearchebleRepository<
  E,
  EntityId,
  Filter
> {
  ...
  async search(props: SearchParams<Filter>): Promise<SearchResult<E>> {
    ...
    const itemsPagianted = this.applyPaginate(itemsSorted, props.page, props.per_page);
